...
class CenterlineFollower:
    def __init__(self):
        ...
        self.lookahead = rospy.get_param("~lookahead", 0.30)
        self.base_speed = rospy.get_param("~base_speed", 0.220)
        self.corner_speed = rospy.get_param("~corner_speed", 0.130)
        self.max_angular = rospy.get_param("~max_angular", 1.80)
        self.heading_gain = rospy.get_param("~heading_gain", 2.85)
        self.cross_track_gain = rospy.get_param("~cross_track_gain", 0.55)
        self.max_cross_track_for_full_slowdown = rospy.get_param("~max_cross_track_for_full_slowdown", 0.13)
